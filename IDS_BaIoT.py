...
def ReadDataFromCSV(benign, g_c, g_j, g_s, g_u, m_a, m_sc, m_sy, m_u, m_u_p, isTest=False):
    ...
    if isTest:
        ...
        benign=benign.sample(frac=0.75,replace=False)
        g_c=g_c.sample(frac=0.52,replace=False)
        g_j=g_j.sample(frac=1,replace=False)
        g_s=g_s.sample(frac=1,replace=False)
        g_u=g_u.sample(frac=0.68,replace=False)
        m_a=m_a.sample(frac=0.68,replace=False)
        m_sc=m_sc.sample(frac=0.38,replace=False)
        m_sy=m_sy.sample(frac=0.28,replace=False)
...
datatrain = ReadDataFromCSV('./Datasets/N_BaIoT/1.benign.csv', './Datasets/N_BaIoT/1.gafgyt.combo.csv', './Datasets/N_BaIoT/1.gafgyt.junk.csv', './Datasets/N_BaIoT/1.gafgyt.scan.csv', './Datasets/N_BaIoT/1.gafgyt.udp.csv', './Datasets/N_BaIoT/1.mirai.ack.csv', './Datasets/N_BaIoT/1.mirai.scan.csv', './Datasets/N_BaIoT/1.mirai.syn.csv', './Datasets/N_BaIoT/1.mirai.udp.csv', './Datasets/N_BaIoT/1.mirai.udpplain.csv', isTest=True)
...
datatrain = datatrain.append(ReadDataFromCSV('./Datasets/N_BaIoT/4.benign.csv', './Datasets/N_BaIoT/4.gafgyt.combo.csv', './Datasets/N_BaIoT/4.gafgyt.junk.csv', './Datasets/N_BaIoT/4.gafgyt.scan.csv', './Datasets/N_BaIoT/4.gafgyt.udp.csv', './Datasets/N_BaIoT/4.mirai.ack.csv', './Datasets/N_BaIoT/4.mirai.scan.csv', './Datasets/N_BaIoT/4.mirai.syn.csv', './Datasets/N_BaIoT/4.mirai.udp.csv', './Datasets/N_BaIoT/4.mirai.udpplain.csv', isTest=True), ignore_index = True)
...
_, _, train_data_loader = DataPreprocessing(datatrain, 3000000, BATCH_SIZE)
...
X_test, y_test, test_data_loader = DataPreprocessing(datatest, 700000, BATCH_SIZE)
